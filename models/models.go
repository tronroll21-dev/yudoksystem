...
T1.回数券全日リアレジ = ?
		...
		_, err = db.Exec(updateQuery, input.ID,
			...
			input.Machine1CashSettleCount,
			input.Machine1CashSettleAmount,
			input.Machine2CashCount,
			input.Machine2CashAmount,
			input.Machine2CashSettleCount,
			input.Machine2CashSettleAmount,
			input.Machine3CashCount,
			input.Machine3CashAmount,
			input.Machine3CashSettleCount,
			input.Machine3CashSettleAmount,
			input.Machine4CashCount,
			input.Machine4CashAmount,
			input.Machine4CashSettleCount,
			input.Machine4CashSettleAmount,
			input.Machine5CashCount,
			input.Machine5CashAmount,
			input.Machine5CashSettleCount,
			input.Machine5CashSettleAmount,
			...
			input.ReportSpace,
			input.KaisuukenHeijitsuKenbaiki,
			input.KaisuukenZenjitsuKenbaiki,
			input.KaisuukenHeijitsuRearegi,
			input.KaisuukenZenjitsuRearegi,
			input.ID)
		if err != nil {
