...
type ReportRecordData struct {
	...
	Machine1CashAmountGoukeiWithUnsettled int
	Machine2CashAmountGoukeiWithUnsettled int
	Machine3CashAmountGoukeiWithUnsettled int
	Machine4CashAmountGoukeiWithUnsettled int
	Machine5CashAmountGoukeiWithUnsettled int
	...
	RearegiTicketAmount                   int
	RearegiRelaxAmount                    int
	RearegiTotalAmount                    int
...
func GetSalesReportByDate(targetDate time.Time) (ReportData, error) {
	...
	reportRecordData := ReportRecordData{
		...
		Machine1CashAmountGoukeiWithUnsettled: Machine1CashAmountGoukeiWithUnsettled,
		Machine2CashAmountGoukeiWithUnsettled: Machine2CashAmountGoukeiWithUnsettled,
		Machine3CashAmountGoukeiWithUnsettled: Machine3CashAmountGoukeiWithUnsettled,
		Machine4CashAmountGoukeiWithUnsettled: Machine4CashAmountGoukeiWithUnsettled,
		Machine5CashAmountGoukeiWithUnsettled: Machine5CashAmountGoukeiWithUnsettled,
		...
		RearegiTicketAmount: record.RearegiTicketAmount,
		RearegiRelaxAmount:  record.RearegiRelaxAmount,
		RearegiTotalAmount:  record.RearegiTicketAmount + record.RearegiRelaxAmount,
